...
class PrjImgCubit extends Cubit<PrjImgState> {
  PrjImgCubit() : super(InitState());
  ...
  void pickImgCamera({
    ...
    try {
      ...
      if (imgFile != null) {
        ...
        // final metaImg = await Utils.addMetadataToImage(
        ...
        if (metaImg != null) {
          ...
          if (locationData != null) {
            imageData.resident = 1;
            imageData.commercial = 0;
    ...
    try {
      ...
      if (imgFiles != null) {
        ...
        if (locationData != null) {
          ...
          imageData.resident = 1;
          imageData.commercial = 0;
          imageData.imageId = subProjectId == 0
              ? projectId
              : subProjectId; // when user add for prject then assign project id and also for sub project then assign subprojectId.
          imageData.imageUri = cImg.path;
          imageData.dos = dos;
          imageData.sync = 0;
          imageData.type = 1;
          ...
          if (response > 0) {
            WorkManagerTaskRegister.syncImage(projectId: projectId, subProjectId: subProjectId);
            // await ApiClient.uploadImage(imageData);
          }
        }
      }
      fetchData(imageId: subProjectId == 0 ? projectId : subProjectId);
